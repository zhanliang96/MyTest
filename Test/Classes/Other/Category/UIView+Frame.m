...
#pragma mark - horizonCenter

- (CGFloat)horizonCenter
{
    return self.frame.origin.x + self.frame.size.width / 2.0f;
}

- (void)setHorizonCenter:(CGFloat)newHorizonCenter
{
    CGFloat delta = newHorizonCenter - (self.frame.origin.x + self.frame.size.width / 2.0f);
    CGRect newframe = self.frame;
    newframe.origin.x += delta ;
    self.frame = newframe;
}
...
- (void)setVerticalCenter:(CGFloat)newVerticalCenter
{
    CGRect newframe = self.frame;
    newframe.origin.y = newVerticalCenter - self.frame.size.height / 2.0f;
    self.frame = newframe;
}
